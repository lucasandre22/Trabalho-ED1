...
/**Função que faz a lista de localidades ordenada, cada localidade aparece uma vez,
para poder ser feito o mapeamento de cada uma.**/
...
/**Realiza a busca binária no vet_id, para saber qual índice a localidade
representa**/
